 ...
 * @brief Application context class for solving the Einstein equations in EMDA formulation. 
 * @version 0.1
 * @date 2019-12-20
 * 
...
namespace dsolve
{
    ...
    public:
        ...
        /**
             ...
             * @param tadapoffst 
             */
        void set_time_adap_offset(unsigned int tadapoffst) { DENDROSOLVER_LTS_TS_OFFSET = tadapoffst; }
        ...
        unsigned int get_async_batch_sz() { return dsolve::DENDROSOLVER_ASYNC_COMM_K; }
        ...
        const unsigned int *get_refine_var_ids() { return DENDROSOLVER_REFINE_VARIABLE_INDICES; }
        ...
        std::function<double(double, double, double, double *hx)> get_wtol_function()
        {
            ...
            std::function<double(double, double, double, double *)> waveletTolFunc = [](double x, double y, double z, double *hx) { return dsolve::computeWTolDCoords(x, y, z, hx); };
        ...
        bool is_bh_merged(double tol) const { return ((dsolve::DENDROSOLVER_BH_LOC[0] - dsolve::DENDROSOLVER_BH_LOC[1]).abs() < tol); };
    };
