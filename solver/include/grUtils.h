...
namespace dsolve
{
    ...
    /**
     * @brief calculate and set the initial data for superposed boosted kerr-sen 
     * @param xx1 : x coord, real and true coordinate
     * @param yy1 : y coord, real and true coordinate
     * @param zz1 : z coord, real and true coordinate
     * @param var : initialized dsolve variables for the grid points
     */
    void superposedBoostedKerrSenInit(double x, double y, double z, double *u);

    /**
     * @brief calculate and set the initial data for boosted kerr-sen
     * @param xx1 : x coord
     * @param yy1 : y coord
     * @param zz1 : z coord
     * @param var : initialized dsolve variables for the grid points
     */
    void boostedKerrSenInit(double x, double y, double z, double *u);

    /**
     * @brief calculate and set the initial data for kerr-sen
     * @param xx1 : x coord
     * @param yy1 : y coord
     * @param zz1 : z coord
     * @param var : initialized dsolve variables for the grid points
     */
    void kerrsenInit(double x, double y, double z, double *u);

    /**
     * @brief calculate and set the initial data for Schwarzschild
     * @param xx1 : x coord
     * @param yy1 : y coord
     * @param zz1 : z coord
     * @param var : initialized dsolve variables for the grid points
     */
    void schwarzschildInit(double x, double y, double z, double *u);

    /**
     * @brief calculate and set the initial data for Frankenstein
     * @param xx1 : x coord
     * @param yy1 : y coord
     * @param zz1 : z coord
     * @param var : initialized dsolve variables for the grid points
     */
    void frankensteinInit(double x, double y, double z, double *u);

    /**
     * @brief calculate and set the initial data for dyonic Kerr-Newman
     * @param xx1 : x coord
     * @param yy1 : y coord
     * @param zz1 : z coord
     * @param var : initialized dsolve variables for the grid points
     */
    void dyonicKerrNewmanInit(double x, double y, double z, double *u);

    /**
     * @brief calculate and set the initial data for Minkowski
     * @param xx1 : x coord
     * @param yy1 : y coord
     * @param zz1 : z coord
     * @param var : initialized dsolve variables for the grid points
