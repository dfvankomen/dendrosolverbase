 ...
 * @brief Contins utility functions for processing simulation data and post processing
 */

#ifndef DENDROSOLVER_DATAUTILS_H_
#define DENDROSOLVER_DATAUTILS_H_
...
#endif // DENDROSOLVER_DATAUTILS_H_
