...
#ifdef DENDRO_VTU_ASCII
            fprintf(fp, "        <DataArray type=\"%s\" Name=\"connectivity\""
                        " format=\"%s\">\n",
...
#ifdef DENDRO_VTU_ASCII
            fprintf(fp, "        <DataArray type=\"%s\" Name=\"offsets\""
                        " format=\"%s\">\n",
                    DENDRO_NODE_ID_TYPE, DENDRO_FORMAT_ASCII);
            fprintf(fp, "         ");
...
#ifdef DENDRO_VTU_ASCII
            fprintf(fp, "        <DataArray type=\"%s\" Name=\"mpi_rank\""
                        " format=\"%s\">\n",
...
#ifdef DENDRO_VTU_ASCII
            fprintf(fp, "        <DataArray type=\"%s\" Name=\"cell_level\""
                        " format=\"%s\">\n",
                    DENDRO_NODE_VAR_INT, DENDRO_FORMAT_ASCII);
            fprintf(fp, "         ");
            for (unsigned int il = 0; il < num_cells; ++il)
...
//std::cout<<"tmp_var: pdata: "<<pdata<<" var: "<<tmp_var[0]<<std::endl;
                    ...
                    if (retval)
                    {
                        ...
                        std::cout << rank << ": [VTU Error]: "
                                  << "base64 encode point vars data failed" << std::endl;
                        fclose(fp);
                    }
...
#ifdef DENDRO_VTU_ASCII
                fprintf(fp, "      <PDataArray type=\"%s\" Name=\"Position\""
...
#ifdef DENDRO_VTU_ASCII
                fprintf(fp, "        <PDataArray type=\"%s\" Name=\"mpi_rank\""
                            " format=\"%s\"/>\n",
                        DENDRO_NODE_VAR_INT, DENDRO_FORMAT_ASCII);
#else
                fprintf(fp, "        <PDataArray type=\"%s\" Name=\"mpi_rank\""
...
#ifdef DENDRO_VTU_ASCII
                fprintf(fp, "        <PDataArray type=\"%s\" Name=\"cell_level\""
                            " format=\"%s\"/>\n",
                        DENDRO_NODE_VAR_INT, DENDRO_FORMAT_ASCII);
#else
                fprintf(fp, "        <PDataArray type=\"%s\" Name=\"cell_level\""
...
#ifdef DENDRO_VTU_ASCII
            fprintf(fp, "        <DataArray type=\"%s\" Name=\"Position\""
                        " NumberOfComponents=\"3\" format=\"%s\">\n",
                    DENDRO_NODE_COORD_TYPE, DENDRO_FORMAT_ASCII);
#else
            fprintf(fp, "        <DataArray type=\"%s\" Name=\"Position\""
