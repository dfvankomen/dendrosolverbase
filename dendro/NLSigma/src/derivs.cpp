  ...
  if (bflag & (1u << OCT_DIR_LEFT))
  {
    for (int k = kb; k < ke; k++)
    {
      for (int j = jb; j < je; j++)
      {
        ...
        DxDxu[IDX(3, j, k)] = (u[IDX(3, j, k)] - 2.0 * u[IDX(4, j, k)] + u[IDX(5, j, k)]) * idx_sqrd;
      }
    }
  }
  ...
  if (bflag & (1u << OCT_DIR_RIGHT))
  {
    for (int k = kb; k < ke; k++)
    {
      for (int j = jb; j < je; j++)
      {
        ...
        DxDxu[IDX(ie - 1, j, k)] = (u[IDX(ie - 3, j, k)] - 2.0 * u[IDX(ie - 2, j, k)] + u[IDX(ie - 1, j, k)]) * idx_sqrd;
      }
    }
  }
...
void deriv22_yy(double *const DyDyu, const double *const u, const double dy, const unsigned int *sz, unsigned bflag)
{
  ...
  if (bflag & (1u << OCT_DIR_DOWN))
  {
    for (int k = kb; k < ke; k++)
    {
      for (int i = ib; i < ie; i++)
      {
        ...
        DyDyu[IDX(i, 3, k)] = (u[IDX(i, 3, k)] - 2.0 * u[IDX(i, 4, k)] + u[IDX(i, 5, k)]) * idy_sqrd;
      }
    }
  }
  ...
  if (bflag & (1u << OCT_DIR_UP))
  {
    ...
    for (int k = kb; k < ke; k++)
    {
      for (int i = ib; i < ie; i++)
      {
        DyDyu[IDX(i, je - 1, k)] = (u[IDX(i, je - 3, k)] - 2.0 * u[IDX(i, je - 2, k)] + u[IDX(i, je - 1, k)]) * idy_sqrd;
      }
    }
  }
  ...
  if (bflag & (1u << OCT_DIR_BACK))
  {
    for (int j = jb; j < je; j++)
    {
      for (int i = ib; i < ie; i++)
      {
        ...
        DzDzu[IDX(i, j, 3)] = (u[IDX(i, j, 3)] - 2.0 * u[IDX(i, j, 4)] + u[IDX(i, j, 5)]) * idz_sqrd;
      }
    }
  }
  ...
  if (bflag & (1u << OCT_DIR_FRONT))
  {
    for (int j = jb; j < je; j++)
    {
      for (int i = ib; i < ie; i++)
      {
        ...
        DzDzu[IDX(i, j, ke - 1)] = (u[IDX(i, j, ke - 3)] - 2.0 * u[IDX(i, j, ke - 2)] + u[IDX(i, j, ke - 1)]) * idz_sqrd;
      }
    }
  }
