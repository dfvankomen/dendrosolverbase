            ...
            for (unsigned int j = 0; j < (eleOrder + 1); j++)
                for (unsigned int i = 0; i < (eleOrder + 1); i++)
                {
                    ...
                    if ((i > 1 && i < eleOrder) && (j > 1 && j < eleOrder) && (k > 1 && k < eleOrder) && fabs(nodalValues[k * (eleOrder + 1) * (eleOrder + 1) + j * (eleOrder + 1) + i] - func(x, y, z)) > tol)
                    {
                        ...
                        std::cout << " nvalue: " << nodalValues[k * (eleOrder + 1) * (eleOrder + 1) + j * (eleOrder + 1) + i] << " actual: " << func(x, y, z) << " ele: " << ele << " (i,j,k) : (" << i << "," << j << "," << k << ") : element : " << pNodes[ele] << " (x,y,z): (" << x << "," << y << "," << z << ")"
                                  << " owner: " << pNodes[owner] << " (i,j,k): (" << ix << "," << jy << "," << kz << " )" << std::endl;
                    }
            ...
            for (unsigned int k = 0; k < lz; k++)
                for (unsigned int j = 0; j < ly; j++)
                    for (unsigned int i = 0; i < lx; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
        ...
        for (unsigned int k = kb; k < ke; k++)
            for (unsigned int j = jb; j < je; j++)
                for (unsigned int i = ib; i < ie; i++)
                {
                    ...
                    {
                        valid = false;
                        std::cout << "rank: " << rank << "blk: " << blkNode << " block[internal] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                  << "sz: " << lx << std::endl;
                    }
                }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_DOWN] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_DOWN_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_DOWN_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_UP] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_UP_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_UP_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[LEFT_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << " x: " << x << " y: " << y << " z: " << z << std::endl;
                            }
                        }
            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << "  block[LEFT_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[RIGHT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << "  block[RIGHT_DOWN] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << "  block[RIGHT_DOWN_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << "  block[RIGHT_DOWN_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << "  block[RIGHT_UP] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << "  block[RIGHT_UP_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << "  block[RIGHT_UP_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[RIGHT_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << " x: " << x << " y: " << y << " z: " << z << std::endl;
                            }
                        }
            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[RIGHT_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[DOWN] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[DOWN_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << " x: " << x << " y: " << y << " z: " << z << std::endl;
                            }
                        }
            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[DOWN_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[UP] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[UP_BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << " x: " << x << " y: " << y << " z: " << z << std::endl;
                            }
                        }
            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[UP_FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[BACK] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
        }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[FRONT] unzip error : unzip value:  " << unzipVec[offset + k * ly * lx + j * lx + i] << "\t func(x,y,z): " << fn(x, y, z) << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
        }
        ...
        for (unsigned int k = kb; k < ke; k++)
            for (unsigned int j = jb; j < je; j++)
                for (unsigned int i = ib; i < ie; i++)
                {
                    ...
                    {
                        valid = false;
                        std::cout << "rank: " << rank << "blk: " << blkNode << " block[internal] unzip error : unzip value: NAN "
                                  << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                  << "sz: " << lx << std::endl;
                    }
                }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[left] unzip error : unzip value: NAN "
                                      << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_down] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_down_back] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_down_front] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_up] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_up_back] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_up_front] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_back] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[left_front] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[right] unzip error : unzip value: NAN "
                                      << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_down] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_down_back] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_down_front] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_up] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_up_back] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                    ...
                    for (unsigned int k = kb; k < ke; k++)
                        for (unsigned int j = jb; j < je; j++)
                            for (unsigned int i = ib; i < ie; i++)
                            {
                                ...
                                {
                                    valid = false;
                                    std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_up_front] unzip error : unzip value: NAN "
                                              << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                              << "sz: " << lx << std::endl;
                                }
                            }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_back] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[right_front] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[down] unzip error : unzip value: NAN "
                                      << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[down_back] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[down_front] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
            ...
            for (unsigned int k = kb; k < ke; k++)
                for (unsigned int j = jb; j < je; j++)
                    for (unsigned int i = ib; i < ie; i++)
                    {
                        ...
                        {
                            valid = false;
                            std::cout << "rank: " << rank << "blk: " << blkNode << " block[up] unzip error : unzip value: NAN "
                                      << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                      << "sz: " << lx << std::endl;
                        }
                    }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[up_back] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
                ...
                for (unsigned int k = kb; k < ke; k++)
                    for (unsigned int j = jb; j < je; j++)
                        for (unsigned int i = ib; i < ie; i++)
                        {
                            ...
                            {
                                valid = false;
                                std::cout << "rank: " << rank << "blk: " << blkNode << " block[up_front] unzip error : unzip value: NAN "
                                          << " (i,j,k): (" << i << ", " << j << "," << k << " )"
                                          << "sz: " << lx << std::endl;
                            }
                        }
...
bool ot::test::isInterpToSphereValid(const ot::Mesh *mesh, const T *zipIn, std::function<T(T, T, T)> func, double r, const double *dMin, const double *dMax, double tolerance)
{
    ...
    if (mesh->isActive())
    {
        ...
        if (!rankActive)
            std::cout << "numPts: " << numPts << " total valid incices: " << validSz_g << std::endl;
