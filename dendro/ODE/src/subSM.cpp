...
ot::SubScatterMap::~SubScatterMap()
{
    ...
    if (m_uiIsAllocated)
    {
        ...
        {
            delete[] m_uiSendCount[l];
            m_uiSendCount[l] = NULL;
            delete[] m_uiSendOffset[l];
            m_uiSendOffset[l] = NULL;
            delete[] m_uiRecvCount[l];
            m_uiRecvCount[l] = NULL;
            delete[] m_uiRecvOffset[l];
            m_uiRecvOffset[l] = NULL;

            m_uiL2SendProcList[l].clear();
            m_uiL2RecvProcList[l].clear();

            delete[] m_uiL2SendSM[l];
            m_uiL2SendSM[l] = NULL;
            delete[] m_uiL2RecvSM[l];
            m_uiL2RecvSM[l] = NULL;
        }

        delete[] m_uiSendCount;
        m_uiSendCount = NULL;
        delete[] m_uiRecvCount;
        m_uiRecvCount = NULL;

        delete[] m_uiSendOffset;
        m_uiSendOffset = NULL;
        delete[] m_uiRecvOffset;
        m_uiRecvOffset = NULL;

        delete[] m_uiL2SendProcList;
        m_uiL2SendProcList = NULL;
        delete[] m_uiL2RecvProcList;
        m_uiL2RecvProcList = NULL;
...
void ot::SubScatterMap::compute_L2SM()
{
    ...
    std::vector<unsigned int> rCts;
    rCts.resize(activeNpes);
    for (unsigned int l = m_uiLMin; l < m_uiLMax + 1; l++)
    {
