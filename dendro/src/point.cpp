...
Point::Point(unsigned int newx, unsigned int newy, unsigned int newz) : _x(static_cast<double>(newx)), _y(static_cast<double>(newy)), _z(static_cast<double>(newz))
{
}

Point::Point(const Point &newposition) : _x(newposition._x), _y(newposition._y), _z(newposition._z)
{
}
/*
Point::~Point()
