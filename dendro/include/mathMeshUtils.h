        ...
        for (unsigned int k = 0; k < DD; k++)
            for (unsigned int j = 0; j < DD; j++)
                for (unsigned int i = 0; i < DD; i++)
                {
                    ...
                    double cell_avg = (nodalVals[(k) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i)] + nodalVals[(k) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i + 1)] + nodalVals[(k) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i)] + nodalVals[(k) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i + 1)] + nodalVals[(k + 1) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i)] + nodalVals[(k + 1) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i + 1)] + nodalVals[(k + 1) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i)] + nodalVals[(k + 1) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i + 1)]) * invNC;
        ...
        for (unsigned int k = 0; k < DD; k++)
            for (unsigned int j = 0; j < DD; j++)
                for (unsigned int i = 0; i < DD; i++)
                {
                    ...
                    double cell_avg1 = (eleVec1[(k) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i)] + eleVec1[(k) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i + 1)] + eleVec1[(k) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i)] + eleVec1[(k) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i + 1)] + eleVec1[(k + 1) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i)] + eleVec1[(k + 1) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i + 1)] + eleVec1[(k + 1) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i)] + eleVec1[(k + 1) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i + 1)]) * invNC;

                    double cell_avg2 = (eleVec2[(k) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i)] + eleVec2[(k) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i + 1)] + eleVec2[(k) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i)] + eleVec2[(k) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i + 1)] + eleVec2[(k + 1) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i)] + eleVec2[(k + 1) * (DD + 1) * (DD + 1) + (j) * (DD + 1) + (i + 1)] + eleVec2[(k + 1) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i)] + eleVec2[(k + 1) * (DD + 1) * (DD + 1) + (j + 1) * (DD + 1) + (i + 1)]) * invNC;
