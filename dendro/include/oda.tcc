...
namespace ot
{
    ...
    DA::DA(std::function<void(T, T, T, T *)> func, unsigned int dofSz, MPI_Comm comm, unsigned int order, double interp_tol, unsigned int grainSz, double sfc_tol, SM_TYPE smType)
    {
        ...
        if (!rank)
            std::cout << GRN << " function to octree max (s): " << t_stat_g[2] << NRM << std::endl;
        if (!rank)
            std::cout << GRN << " function to octree # octants : " << globalSz << NRM << std::endl;
        ...
        if (isActive)
        {
            ...
            if (!rank_active)
                std::cout << GRN << "remove duplicates + octree construction (s): " << t_stat_g[2] << NRM << std::endl;
            if (!rank_active)
                std::cout << GRN << " # const. octants: " << globalSz << NRM << std::endl;
            ...
            if (!rank_active)
                std::cout << GRN << " 2:1 balancing max (s): " << t_stat_g[2] << NRM << std::endl;
            localSz = balOct.size();
        }
        ...
        if (!rank)
            std::cout << GRN << " balanced # octants : " << globalSz << NRM << std::endl;
    ...
    inline void DA::init<ot::DA_FLAGS::WRITABLE>()
    {
        ...
        while ((binOp::getBit(m_uiOctantFlags[count], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(m_uiOctantFlags[count], ODA_INDEPENDENT_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(m_uiOctantFlags[count], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(m_uiOctantFlags[count], ODA_INDEPENDENT_FLAG_BIT) != 1))
            count++;
    ...
    inline void DA::init<ot::DA_FLAGS::INDEPENDENT>()
    {
        ...
        unsigned int count = m_uiLoopInfo.indexBegin;
        while ((binOp::getBit(m_uiOctantFlags[count], ODA_INDEPENDENT_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(m_uiOctantFlags[count], ODA_INDEPENDENT_FLAG_BIT) != 1))
            count++;
    ...
    inline void DA::init<ot::DA_FLAGS::W_DEPENDENT>()
    {
        ...
        unsigned int count = m_uiLoopInfo.indexBegin;
        while ((binOp::getBit(m_uiOctantFlags[count], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(m_uiOctantFlags[count], ODA_W_DEPENDENT_FLAG_BIT) != 1))
            count++;
    ...
    inline void DA::init<ot::DA_FLAGS::W_BOUNDARY>()
    {
        ...
        unsigned int count = m_uiLoopInfo.indexBegin;
        while ((binOp::getBit(m_uiOctantFlags[count], ODA_W_BOUNDARY_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(m_uiOctantFlags[count], ODA_W_BOUNDARY_FLAG_BIT) != 1))
            count++;
    ...
    inline void DA::next<ot::DA_FLAGS::WRITABLE>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
    ...
    inline void DA::next<ot::DA_FLAGS::INDEPENDENT>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
    ...
    inline void DA::next<ot::DA_FLAGS::W_DEPENDENT>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_W_DEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_W_DEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
    ...
    inline void DA::next<ot::DA_FLAGS::W_BOUNDARY>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_W_BOUNDARY_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(m_uiOctantFlags[m_uiLoopInfo.currentIndex], ODA_W_BOUNDARY_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
