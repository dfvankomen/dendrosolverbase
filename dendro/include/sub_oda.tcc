...
namespace ot
{
    ...
    inline void subDA::init<ot::DA_FLAGS::WRITABLE>()
    {
        ...
        while ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_INDEPENDENT_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_INDEPENDENT_FLAG_BIT) != 1))
            count++;
    ...
    inline void subDA::init<ot::DA_FLAGS::INDEPENDENT>()
    {
        ...
        unsigned int count = m_uiLoopInfo.indexBegin;
        while ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_INDEPENDENT_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_INDEPENDENT_FLAG_BIT) != 1))
            count++;
    ...
    inline void subDA::init<ot::DA_FLAGS::W_DEPENDENT>()
    {
        ...
        while ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_W_DEPENDENT_FLAG_BIT) != 1))
            count++;
    ...
    inline void subDA::init<ot::DA_FLAGS::W_BOUNDARY>()
    {
        ...
        while ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_W_BOUNDARY_FLAG_BIT) != 1) && (count < m_uiLoopInfo.indexEnd))
            count++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[count]], ODA_W_BOUNDARY_FLAG_BIT) != 1))
            count++;
    ...
    inline void subDA::next<ot::DA_FLAGS::WRITABLE>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_W_DEPENDENT_FLAG_BIT) != 1) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
    ...
    inline void subDA::next<ot::DA_FLAGS::INDEPENDENT>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_INDEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
    ...
    inline void subDA::next<ot::DA_FLAGS::W_DEPENDENT>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_W_DEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_W_DEPENDENT_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
    ...
    inline void subDA::next<ot::DA_FLAGS::W_BOUNDARY>()
    {
        ...
        while (((m_uiLoopInfo.currentIndex) < m_uiLoopInfo.indexEnd) && (binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_W_BOUNDARY_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;

        if ((binOp::getBit(octFlags[m_uip_sub2DA_ElemMap[m_uiLoopInfo.currentIndex]], ODA_W_BOUNDARY_FLAG_BIT) != 1))
            m_uiLoopInfo.currentIndex++;
    }
